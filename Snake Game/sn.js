{
    ...
    // var y=500
    // var z=x
    // setInterval(chgclr, 10);
    // function chgclr(){
    //     document.getElementById("hdi").style.marginLeft=z+"px"
    //     document.getElementById("div"+idb).style.backgroundColor="black"
    //     document.getElementById("div"+id).style.backgroundColor=clr
    //     if(count%2!=0){
    //     idb=id
    //     id=id+6
    //     count=count+1
